...
(function () {
    ...
    // static assets
    app.use(express.static(path.join(__dirname, '../test'))); // read file content /tux_static/js/sample.js
    app.use('/tux_static', listDirectory('test/tux_static', {'icons': true})); // serve directory listing

    // home route
    app.get('/', function (req, res) {
        res.render("home.dust", recipe);
    });
